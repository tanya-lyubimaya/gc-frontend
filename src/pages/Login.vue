<template>
  <q-page class="flex flex-center">
    <div class="text-center q-pa-md flex flex-center">
      <div class="q-pa-md flex flex-center rounded-borders">
        <div class="col-6">
          <q-card bordered class="q-pa-lg">
            <q-card-section>
              <div class="text-h4">Авторизация</div>
            </q-card-section>
            <q-card-actions class="q-px-md q-gutter-lg">
              <q-btn
                type="a"
                size="lg"
                :href="redirectUri"
...
export default {
  computed: {
    redirectUri() {
      return (process.env.PROD ? 'https://constructor.auditory.ru' : 'https://constructor.auditory.ru') +
        '/auth/login/google?redirect_url=' +
